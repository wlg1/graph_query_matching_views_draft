...
public class DagSimFilter {
	...
	private void pruneOneStepBUP_c(QNode parent, ArrayList<QNode> qnodes_c, RoaringBitmap candBits,
			boolean[] changed) {
	...
	private void pruneOneStepBUP_d(QNode parent, ArrayList<QNode> qnodes_d, ArrayList<GraphNode> candList_p, RoaringBitmap candBits_p,
			boolean[] changed) {
	...
	private void pruneOneStepTDW_d(QNode child, ArrayList<QNode> qnodes_d, ArrayList<GraphNode> candList_c, RoaringBitmap candBits_c,
			boolean[] changed) {
