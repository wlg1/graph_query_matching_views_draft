...
public class QueryGenerator {
	...
	public QueryGenerator(String inFN, double theta) {
	...
	public void generateQueries(int numQ, int maxDepth, double dSlash, int noNestedPaths, double nestedPathProbs,
		...
		try {
			QNode rootq = null;
			PrintWriter pw = new PrintWriter(new FileOutputStream(outFilename, true));
	...
	public static void main(String[] args) {
		...
		QueryGenerator qg = new QueryGenerator
				//(".//data//wordnet.dag", 0.8);
				(".//data//outputacm.dag", 0.8);
				//(".//data//dblpcitation.dag", 0.8);
				//(".//data//citeseer_sub_lb10.lg", 0.8);
		...
		double dSlash = 0.6;
		int noNestedPaths = 3;
		double nestedPathProb = 0.7;
		int levelPathNesting = maxDepth;
		String outFilename =
				//".//data//wordnet.qry";
				".//data//outputacm.qry";
				//".//data//dblpcitation.qry";
				//".//data//citeseer_sub_rand_q.txt";
