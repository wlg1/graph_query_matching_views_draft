...
import mv.queryEvaluator.DagEvalMVFltSimViewMat;
...
public class DagMVFltSimMainViewMat {
	...
	public DagMVFltSimMainViewMat(String dataFN, String queryFN, String viewFN) {
...
//		System.exit(0);
	...
	private void evalOneList() {
		...
		ArrayList<ArrayList<Pool>> viewPools = ViewManager.genViewMat(views, g, bfl);
		...
		for (int i = 0; i < Flags.REPEATS; i++) {
			for (int Q = 0; Q < queries.size(); Q ++) {
				...
				DagEvalMVFltSimViewMat eva = new DagEvalMVFltSimViewMat(query, views, g, bfl, viewPools);
...
//					System.exit(1);
	...
	public static void main(String[] args) {
		...
		DagMVFltSimMainViewMat demain = new DagMVFltSimMainViewMat(dataFileN, queryFileN, viewFileN);
