...
//		theMain.run(dataFileN, queryFileN, viewFileN);
		...
		String dataFileN = "bs_lb20_v1_350K_nodes.dag";
//		String dataFileN = "am_lb24_v1_300K_nodes.dag";
//		String[] splitDataFileName = dataFileN.split("[.]", 0);
		String DataFileNameNoExt = dataFileN.replaceFirst("[.][^.]+$", "");
...
//		    	String prefix = splitFileName[0];
		    	...
		    	String prefix = child.getName().replaceFirst("[.][^.]+$", "");
		    	if (ext.equals("qry")) {
		    		String queryFileN = prefix + ".qry";
		    		String viewFileN = prefix + ".vw";
		    		String allFileN = DataFileNameNoExt + "_" + prefix + "_ALL";
		    		combinedMain theMain = new combinedMain();
