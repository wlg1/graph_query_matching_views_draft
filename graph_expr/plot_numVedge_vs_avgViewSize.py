...
for numE in range(2,totNumE + 1):
    ...
    input_path = 'output/Email_lb20_lb20_cyc_m_'+str(numE)+'Eviews/'
...
plt.savefig('avgViewSizes.png', bbox_inches="tight")
...
for qrynum in range(1,13):
    ...
    for algoName in algoNames:
        ...
        plt.plot(xAxis, yAxis, label = algoName)
    plt.legend(bbox_to_anchor=(1, 1), loc='upper left')
    plt.savefig('q'+str(qrynum+6)+'_ViewSizes.png', bbox_inches="tight")
