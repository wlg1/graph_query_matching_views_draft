...
public class CycSimGraFilter {
	...
	public CycSimGraFilter(Query query, GraphNode[] graNodes, ArrayList<ArrayList<GraphNode>> invLstsByID,
	...
	private void init() {
		...
		for (int i = 0; i < size; i++) {
			...
			for (int j = 0; j < invLst.size(); j++) {
				...
				adjMap_f[j] = new AdjMap(mDag.V);
				adjMap_b[j] = new AdjMap(mDag.V);
