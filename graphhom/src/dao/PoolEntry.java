...
public class PoolEntry implements Comparable<PoolEntry> {
	...
	public PoolEntry(int pos, QNode q, GraphNode val, HashMap<Integer, ArrayList<PoolEntry>> FwdEntries, 
			HashMap<Integer, ArrayList<PoolEntry>> mBwdEntries, HashMap<Integer, RoaringBitmap> mFwdBits, 
			HashMap<Integer, RoaringBitmap> mBwdBits, double numChildren, double numParents, double size) {
		mPos = pos; 
		mQNode = q;
		mValue = val;
